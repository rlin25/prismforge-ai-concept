-- Phase 2 Multi-Agent Validation System (ULTRA SIMPLE VERSION)
-- PrismForge AI - Professional M&A Validation Platform
-- This creates the essential tables with minimal complexity
...
CREATE TABLE IF NOT EXISTS analysis_sessions (
    ...
    optimized_context JSONB DEFAULT '{}',
    token_budget INTEGER DEFAULT 80000,
    professional_quality_threshold DECIMAL(3,2) DEFAULT 0.85,
...
-- Add unique constraint on execution_id after table creation
